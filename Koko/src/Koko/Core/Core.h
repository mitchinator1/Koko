 ...
 * and not some other Apple platform */
	...
	#define KOKO_PLATFORM_IOS
	#error "IOS is not supported!"
#elif TARGET_OS_MAC == 1
	#define KOKO_PLATFORM_MACOS
...
#ifdef KOKO_DEBUG
	#define KK_ENABLE_ASSERTS
#endif

#ifdef KOKO_ENABLE_ASSERTS
...
#define BIT(x) (1 << x)
#define KK_BIND_EVENT_FN(x) std::bind(&x, this, std::placeholders::_1)
